...
export const v2FeatureSchema = z.enum([
  ...
  'getSharedView',
  'getSharedViewRecords',
  'getSharedViewRowCount',
  'getSharedViewSearchCount',
  'getSharedViewSearchIndex',
  'getSharedViewAggregations',
  'getSharedViewGroupPoints',
  'getSharedViewCalendarDailyCollection',
  'getSharedViewLinkRecords',
  'getSharedViewCollaborators',
  'getSharedViewCopy',
  'getDefaultViewId',
  'manualSortView',
  'getView',
